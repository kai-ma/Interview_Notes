...
![img](images/network-basic/OSI七层模型.png)
...
![img](images/network-basic/网络包数据格式.jpeg)
...
![img](images/network-basic/建立连接时的信息.jpeg)
...
<img src="images/network-basic/TCP头部格式.jpeg" alt="img" style="zoom:50%;" />
...
<img src="images/network-basic/窗口关闭潜在的死锁危险.png" alt="img" style="zoom:50%;" />
...
![img](images/network-basic/TCP拥塞控制.png)
...
<img src="images/network-basic/TCP拥塞控制-快重传.png" alt="img" style="zoom:70%;" />
...
![img](images/network-basic/Linux查看TCP状态.jpeg)



## 针对 TCP 应该如何 Socket 编程？

![img](images/network-basic/TCP-Socket.jpeg)
...
![img](images/network-basic/UDP头部格式.jpeg)
...
<img src="images/network-basic/三次握手.jpeg" alt="img" style="zoom:67%;" />
...
![img](images/network-basic/四次挥手.jpeg)断开一个 TCP 连接则需要“四次挥手”：
...
<img src="images/network-basic/四次挥手socket.jpeg" alt="img" style="zoom:67%;" />
...
![img](images/network-basic/TCP连接处理正常流程.jpeg)
...
<img src="images/network-basic/syncookies解决syn攻击.jpeg" alt="img" style="zoom:67%;" />
...
![img](images/network-basic/IP数据报格式.jpg)
...
![IP分片-片偏移](images/network-basic/IP分片-片偏移.png)
...
<img src="images/network-basic/IP编址方式-分类.png" alt="img" style="zoom:50%;" />
...
<img src="images/network-basic/子网掩码.jpeg" alt="img" style="zoom:50%;" />
...
<img src="images/network-basic/无分类CIDR.png" alt="img" style="zoom:50%;" />



## ICMP

> 腾讯云暑期实习3面问到。**Ping的原理是什么？Traceroute的原理是什么？最大的TTL设置为多少？**

**互联网控制报文协议**，ip数据报传输过程中出错，路由器并不是直接简单地丢弃，而是向出错的报文的源主机发送差错报告。

ICMP 是为了更有效地转发 IP 数据报和提高交付成功的机会。它封装在 IP 数据报中，但是不属于高层协议。

ICMP 报文分为差错报告报文和询问报文。

![img](images/network-basic/types-of-ICMP.png)
...
- 之后源主机知道了**到达目的主机所经过的路由器 IP 地址以及到达每个路由器的往返时间。**

**TTL是一个8 bit字段，TTL的最大值是255，TTL的一个推荐值是64。**
